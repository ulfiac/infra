...
def lambda_handler(event, context):
    """
    AWS Lambda function to interact with Amazon Bedrock Invoke_Model API.
    """

    # extract the aws_region from the event, return if not present
    try:
    ...
    # prep the body as a json string
    body = json.dumps({
        "messages": messages,
